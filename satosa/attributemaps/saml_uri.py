...
SAML_ATTRIBUTE = "urn:oasis:names:tc:SAML:attribute:"
MAP = {
    "identifier": "urn:oasis:names:tc:SAML:2.0:attrname-format:uri",
    "fro": {
        SAML_ATTRIBUTE + "subject-id": "subject-id",
        SAML_ATTRIBUTE + "pairwise-id": "pairwise-id",
    ...
    "to": {
        "subject-id": SAML_ATTRIBUTE + "subject-id",
        "pairwise-id": SAML_ATTRIBUTE + "pairwise-id",
